        ...
        <div class="card">
            <div class="card-body login-card-body shadow-100">
                ...
                <form id="login-form" method="POST" action="{{ admin_url('auth/login') }}">
                    ...
                    <!-- <button type="submit" class="btn btn-secondary float-left register-btn">

                        {{ __('login.register') }}

                    </button> -->

                    <a href="{{admin_url('register')}}" class="btn btn-secondary float-left register-btn">{{ __('login.register') }}</a>
